...
# rawDailyData1981<-readNWISdv(Sites,parameterCd, startDate = "1981-01-01", endDate = "1981-12-31") #statCd = "00003 defaults
# rawDailyData<-rbind(rawDailyData1981,rawDailyData)
